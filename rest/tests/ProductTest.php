...
class ProductTest extends TestCase
{
    ...
    {
        /**
         * The get method takes only two arguments.
         * The URL we are requesting data from and an array that contains the request header like access token etc.
         * In this tutorial we will leave the header empty.
         */
        $this->get("products", []);
    ...
    public function testShouldCreateProduct()
    {
        ...
        /**
         * The post, put and delete methods takes three arguments.
         *  The URL, the request parameters and the request header.
         */
